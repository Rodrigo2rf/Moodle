...
/**
 * Essa pagina exibe em um popup as observacoes adicionada pelo professor/tutor
 *
...
$question_obj = $DB->get_record('question', array('id' => $id));
...
// Start output.
$title = 'Observação adicionada a questão: '.$question->name;
...
echo html_writer::start_tag('div', array('class' => 'que'));
echo html_writer::start_tag('div', array('class' => 'formulation'));
echo html_writer::tag('p', $question_obj->observacao, array('class' => 'nameclass'));
echo html_writer::link('question.php?returnurl=/question/edit.php?courseid='.$courseid.'&courseid='.$courseid.'&id=' .$id , 'Editar questão');
echo html_writer::end_tag('div');
echo html_writer::end_tag('div');

// Output the technical info.
print_collapsible_region_start('', 'techinfo', 'Informações da questão'. $OUTPUT->help_icon('technicalinfo', 'question'), 'core_question_preview_techinfo_collapsed', true);
